    ...
    <td valign="top" class="edittext" align="left">
        <form name="myedit2" id="myedit2" action="[{ $oViewConf->getSelfLink() }]" method="post">
            ...
            [{ if $smxAction == "smx_mail" }]
                ...
                <input type="text" name="smx_mail_to" value="[{ if $smxMailTo }][{ $smxMailTo }][{ else }][{ $user->oxuser__oxusername->value }][{ /if }]" size="50" class="editinput">
                <br /><br />
                
                [{ oxmultilang ident="SMX_ORDER_REMARK_MAILSUBJECT" }]<br />
                <input type="text" name="smx_mail_subject" value="[{ if $smxMailSubject }][{ $smxMailSubject }][{ /if }]" size="50" class="editinput">
                <br /><br />
